    ...
    <div class="row sign-in">
      <div class="col-sm">
        ...
        <div class="p-5 border border-primary-subtle rounded">
          <form class="border-bottom pb-3" action="process_add_category.php" method="post">

            <div class="input-group mt-3 mb-3">
              <span class="input-group-text" id="lblCatName"><i class="fa-solid fa-user"></i></span>
              <input type="text" class="form-control" name="txtCatName" placeholder="Tên người dùng - email">
            </div>
            <div class="input-group mt-3 mb-3">
          ...
          <div class="text-primary float-end mt-2 "><a href="/CSE485_2023/views/client/signup.view.php">Đăng ký tài khoản</a></div>
