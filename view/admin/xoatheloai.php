...
if(!$id){
    redirect('quanlytheloai.php', ['failure' => 'Không tìm thấy thể loại']);
}
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    try{
        ...
        redirect('quanlytheloai.php', ['success' => 'Đã xóa thể loại']);
    }
    catch(PDOException $e){
        if($e->errorInfo[1] == 1451){
            redirect('quanlytheloai.php', ['failure' => 'Thể loại '.$category['ten_tloai'].' có chứa các bài viết khác.
...
<?php include '../includes/header_admin.php'; ?>
    <main class="container admin d-flex justify-content-center" id="content" style="min-height: 50vh; margin-top: 200px">
        <form action="xoatheloai.php?id=<?= $id; ?>" method="POST" class="narrow">
            ...
            <div class="row">
                ...
                <div class="col-6 d-flex justify-content-end">
                    <a href="quanlytheloai.php" class="btn btn-warning">Quay lại</a>
                </div>
            </div>
        </form>
    </main>
