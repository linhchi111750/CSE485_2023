...
<body onload="time()">
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <li class="active"><a href="#home">QUẢN LÝ TÁC GIẢ</a></li>
    ...
    <div class="container-fluid al">
        <div id="clock"></div>
        <Br>
        <p class="timkiemnhanvien"><b>TÌM KIẾM TÁC GIẢ:</b></p><Br><Br>
        <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Nhập ID tác giả cần tìm..."
            data-toggle="tooltip" data-placement="bottom" title="Tìm Kiếm tác giả">
        ...
        <button class="nv btn add-new" type="button" data-toggle="tooltip" data-placement="top"
            title="Thêm tác giả"><i class="fas fa-user-plus"></i></button>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(".add-new").click(function () {
                ...
                var row = '<tr>' +
                    '<td><input type="text" class="form-control" name="ma_tgia" id="ma_tgia" placeholder="Nhập mã tác giả"></td>' +
                    '<td><input type="text" class="form-control" name="ten_tgia" id="ten_tgia" placeholder="Nhập Tên tác giả"></td>' +
                    '<td><input type="text" class="form-control" name="hinh_tgia" id="hinh_tgia" placeholder=""></td>' +
