...
if(!$id){
    redirect('quanlytacgia.php', ['failure' => 'Không tìm thấy tác giả']);
}
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    pdo($pdo, $sql, ['ma_tgia' => $id]);
    unlink('../images/images_tacgia/'.$result['hinh_tgia']);
    redirect('quanlytacgia.php', ['success' => 'Đã xóa tác giả']);
}
?>
<?php $title = "Xoá tác giả"; require '../includes/header_admin.php'; ?>
    <main class="container admin d-flex justify-content-center" id="content" style="min-height: 50vh; margin-top: 200px">
        <form action="xoatacgia.php?id=<?= $id; ?>" method="POST" class="narrow">
