        ...
        <form action="xoabaiviet.php?id=<?= $id; ?>" method="POST" class="narrow">
            ...
            <div class="row">
                ...
                <div class="col-6 d-flex justify-content-end">
                    <a href="quanlybaiviet.php" class="btn btn-warning">Quay lại</a>
                </div>
            </div>
        </form>
    </main>
