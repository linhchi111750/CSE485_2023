...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($_FILES['hinh_tgia']['error'] === 0) {
        ...
        if ($invalid) {
            ...
            if ($save) {
                redirect('quanlytacgia.php', ['success' => 'Đã lưu thành công']);
            } else {
                redirect('quanlytacgia.php', ['failure' => 'Lưu không thành công']);
            }
        }
    }
}
...
<main class="container mt-5 mb-5">
    ...
    <?php } ?>
    <form action="themtacgia.php" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-sm">
