...
<body onload="time()">
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <li class="active"><a href="#home">QUẢN LÝ NGƯỜI DÙNG</a></li>
    ...
    <div class="container-fluid al">
        ...
        <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Nhập ID người dùng cần tìm..."
            data-toggle="tooltip" data-placement="bottom" title="Tìm Kiếm người dùng">
        <i class="fa fa-search" aria-hidden="true"></i>

        <form action="">

        </form>
        <b>THÊM NGƯỜI DÙNG:</b><Br>
        ...
        <table class="table table-bordered" id="myTable">
            <thead>
                <tr class="ex">
                    <th width="auto">Mã người dùng</th>
                  
                    <th>Tên người dùng</th>
                    <th>Mật khẩu người dùng</th>
                    <th>Mail người dùng</th>
            ...
            while($row = $result ->fetch_assoc()){
                ...
                <td>".$row['mail_user']."</td>
                <td>
                <a class ='edit' href='#' aria-hidden='true'>Sửa</a>
                <a class ='delete' href='#' aria-hidden='true'>Xóa</a>
                <a class ='add' href='#' aria-hidden='true'>Lưu lại</a>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(".add-new").click(function () {
                ...
                var row = '<tr>' +
                    '<td><input type="text" class="form-control" name="ma_user" id="ma_tloai" placeholder="Nhập mã người dùng"></td>' +
                    '<td><input type="text" class="form-control" name="ten_user" id="ten_tloai" placeholder="Nhập Tên người dùng"></td>' +
                    '<td><input type="text" class="form-control" name="password_user" id="password_user" placeholder="Nhập mật khẩu người dùng"></td>' +
                    '<td><input type="text" class="form-control" name="mail_user" id="mail_user" placeholder="Nhập Mail người dùng"></td>' +
                    '<td>' + actions + '</td>' +
                    '</tr>';
                $("table").append(row);
