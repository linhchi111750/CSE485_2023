...
if($id){
    ...
    if(!$article){
        redirect('quanlybaiviet.php', ['failure' => 'Không tìm thấy bài viết']);
    }
}
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($invalid){
        ...
        redirect('quanlybaiviet.php', ['success' => 'Đã lưu bài viết']);
    }
    $article['hinhanh'] = $saved_image ? $article['hinhanh'] : '';
}
?>
<?php include '../includes/header_admin.php'; ?>
    <form action="thembaiviet.php?id=<?= $id ?>" method="POST" enctype="multipart/form-data">
        <main class="container" id="content">
        <h3 class="text-center text-uppercase fw-bold mt-4">Thêm  bài viết</h3>
            ...
            <div class="row">
                ...
                <?php } else { ?>
                    ...
                    <img src="../images/images_tacgia/<?= html_escape($article['hinhanh']) ?>"
                ...
                <section class="text col-sm-6">
                    ...
                    <div class="mt-2 mb-2 d-flex justify-content-end">
                        ...
                        <a href="quanlybaiviet.php" class="btn btn-warning m-1">Quay lại</a>
                    </div>
                </section>
            </div>
        </main>
