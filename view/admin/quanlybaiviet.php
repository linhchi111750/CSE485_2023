...
<head>
 <style> <?php include "CSE485_2023/css/cssbaiviet.css"; ?> </style>
    <meta charset="UTF-8">
...
<body onload="time()">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="/CSE485_2023/view/admin/quanlytheloai.php"  >QUẢN LÝ THỂ LOẠI</a></li>
                    ...
                    <li class="active"><a href="#home">QUẢN LÝ BÀI VIẾT</a></li>
    ...
    <div class="container-fluid al">
        <div id="clock"></div>
        <Br>
        <p class="timkiemnhanvien"><b>TÌM KIẾM BÀI VIẾT:</b></p><Br><Br>
        <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Nhập ID bài viết cần tìm..."
            data-toggle="tooltip" data-placement="bottom" title="Tìm Kiếm bài viết">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(".add-new").click(function () {
                ...
                var row = '<tr>' +
                    '<td><input type="text" class="form-control" name="ma_bviet" id="ma_bviet" placeholder="Nhập mã bài viết"></td>' +
                    '<td><input type="text" class="form-control" name="tieude" id="tieude" placeholder="Nhập Tiêu đề bài viết"></td>' +
                    '<td><input type="text" class="form-control" name="ten_bhat" id="ten_bhat" value="" placeholder="Nhập Tên bài hát"></td>' +
                    '<td><input type="text" class="form-control" name="ma_tloai" id="ma_tloai" value="" placeholder="Nhập mã thể loại"></td>' +
                    '<td><input type="text" class="form-control" name="tomtat" id="tomtat" value="" placeholder="Nhập Tóm tắt bài viết"></td>' +
                    
                    '<td><input type="text" class="form-control" name="ma_tgia" id="ma_tgia" value="" placeholder="Nhập mã tác giả"></td>' +
                    '<td><input type="text" class="form-control" name="ngayviet" id="ngayviet" value="" placeholder="Nhập Ngày viết bài viết"></td>' +
                    '<td>' + actions + '</td>' +
                    '</tr>';
                $("table").append(row);
