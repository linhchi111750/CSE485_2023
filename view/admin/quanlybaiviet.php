    ...
    <main class="container mt-4 mb-5">
        <div class="row">
            <div class="col-sm table-responsive-sm" style="overflow: auto;">
                ...
                <a href="thembaiviet.php" class="btn btn-success mb-2">Thêm mới</a>
                    ...
                    <tbody>
                        <?php foreach($articles as $article){ ?>
                            <tr>
                                ...
                                <td>
                                    <a href="suabaiviet.php?id=<?= html_escape($article['ma_bviet']); ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                                <td>
                                    <a href="xoabaiviet.php?id=<?= html_escape($article['ma_bviet']); ?>"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
