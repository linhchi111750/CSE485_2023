...
if ($id) {
    ...
    if (!$result) {
        redirect('quanlytacgia.php', ['failure' => 'Không tìm thấy bài viết']);
    }
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    redirect('quanlytacgia.php', ['success' => 'Sửa thành công tác giả']);
}
...
<main class="container mt-5 mb-5">
    ...
    <div class="row">
        <div class="col-sm">
            ...
            <form action="suatacgia.php?id=<?= $id ?>" method="post" enctype="multipart/form-data">
                ...
                <img src="../images/images_tacgia/<?= html_escape($result['hinh_tgia']) ?>" alt="<?= html_escape($result['hinh_tgia']) ?>" width="300px" >
                <div class="row">
                </div>

                <div class="form-group  float-end ">
                    <input type="submit" value="Lưu lại" class="btn btn-success">
                    <a href="quanlytacgia.php" class="btn btn-warning ">Quay lại</a>
                </div>
            </form>
        </div>
    </div>
