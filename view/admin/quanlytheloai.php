    ...
    <main class="container mt-4 mb-5">
        <div class="row">
            <div class="col-sm table-responsive-sm">
                ...
                <a href="themtheloai.php" class="btn btn-success mb-2">Thêm mới</a>
                    ...
                    <tbody> 
                        <?php foreach($categories as $category) {?>
                            <tr>
                                ...
                                <td>
                                    <a href="suatheloai.php?id=<?= html_escape($category['ma_tloai']); ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                                <td>
                                    <a href="xoatheloai.php?id=<?= html_escape($category['ma_tloai']); ?>"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
